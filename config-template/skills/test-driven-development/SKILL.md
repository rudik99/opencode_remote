...
**Related:** For browser-based changes, combine TDD with runtime verification using Playwright MCP — see the Browser Testing section below.
...
For anything that runs in a browser, unit tests alone aren't enough — you need runtime verification. Use Playwright MCP to inspect the page, console logs, network requests, accessibility state, and screenshots.

### The Playwright Debugging Workflow
...
Follow the installed visual-verification instructions for the repository's Playwright MCP workflow.
