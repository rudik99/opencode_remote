...
For detailed profiling and optimization, use the `performance-optimizer` subagent and performance checklist. Does the change introduce performance problems?
